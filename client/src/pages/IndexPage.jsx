import { Menu, Person, SearchOutlined, SendOutlined } from '@material-ui/icons';
  ...
  return (
    ...
    <div >
      <header className=' p-4 flex justify-between'>
        ...
        <div className='flex border border-gray-500 rounded-full items-center py-2 px-4  shadow-md shadow-gray-300'>
        ...
        <Link to={'/login'} className='flex border border-gray-500 rounded-full p500 items-center py-2 px-4 gap-5'>
          <Menu></Menu>
          <div className=' bg-gray-500 text-white rounded-full border border-gray-500 overflow-hidden '>
            <Person className=' relative top-1 '></Person>
          </div>
        </Link>
      </header>
    </div>
